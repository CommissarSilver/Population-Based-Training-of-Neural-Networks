...
class ActorCriticNetwork(tf.keras.Model):
    def __init__(self, observation_dims, output_dims, name='ActorCritic', checkpoint_directory='\AC-Multi-Models'):
        ...
        self.dense_layer_5 = tf.keras.layers.Dense(units=32, activation='relu', name='Dense_Layer_5', dtype=tf.float32)
